  ...
  return (
    <AppShell>
      <div className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  {statsLoading ? (
                    ...
                    <NumberTicker
                      ...
                      className="mt-1 text-2xl font-bold text-slate-100 block"
                    />
                  )}
                </div>
                <div className="text-3xl">🏋️</div>
              </div>
              <BorderBeam size={80} duration={6} colorFrom="#8b5cf6" colorTo="#6366f1" borderWidth={1.5} />
            </Card>
          </BlurFade>
        ...
        {/* Weight Trend Chart */}
        {chartData.length > 0 && (
          <BlurFade delay={0.3} duration={0.45} inView>
            <Card>
        ...
        {/* Recent Workouts */}
        <BlurFade delay={0.36} duration={0.45} inView>
          <Card>
        ...
        {profile?.fitness_goal && (
          <BlurFade delay={0.42} duration={0.45} inView>
